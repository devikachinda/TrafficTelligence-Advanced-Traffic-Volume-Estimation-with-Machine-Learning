...
model = pickle.load(open(r"C:\Users\Mokshith\OneDrive\Desktop\TrafficTelligence-Advanced-Traffic-Volume-Estimation-with-Machine-Learning-main\model (1).pkl", "rb"))
encoder = pickle.load(open(r"C:\Users\Mokshith\OneDrive\Desktop\TrafficTelligence-Advanced-Traffic-Volume-Estimation-with-Machine-Learning-main\encoder.pkl", "rb"))
